...
public class MergeLeadPage extends ProjectSpecificMethods{
	...
	@FindBy(how = How.XPATH, using = "(//div[@class='x-grid3-cell-inner x-grid3-col-partyId']//a)[2]") private WebElement elementSecondResultingLead;
	@FindBy(how = How.LINK_TEXT, using = "Fusionar") private WebElement elementMerge;
